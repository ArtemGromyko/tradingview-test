...
export class UDFCompatibleDatafeedBase {
    ...
    _setupWithConfiguration(configurationData) {
        ...
        if (!this._configuration.supports_search && !this._configuration.supports_group_request) {
            throw new Error('Unsupported datafeed configuration. Must either support search, or support group request');
        }
        if (this._configuration.supports_group_request || !this._configuration.supports_search) {
